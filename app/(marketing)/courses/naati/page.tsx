...
export const metadata: Metadata = {
  title: 'NAATI CCL Coaching | Alpha PTE & NAATI',
  description: 'Prepare for the NAATI CCL test with our expert instructors. Master dialogue interpretation techniques and achieve certification.',
  openGraph: {
    title: 'NAATI CCL Coaching | Alpha PTE & NAATI',
    description: 'Prepare for the NAATI CCL test with our expert instructors. Master dialogue interpretation techniques and achieve certification.',
    images: [
...
const naatiCourses = [
  {
    ...
    description: 'Comprehensive preparation program for the NAATI Credentialed Community Language test with expert instructors.',
    duration: '6 weeks',
  ...
  },
  {
    ...
    description: 'Focused weekend workshops for professionals preparing for the NAATI CCL test.',
    duration: '4 weekends',
  ...
  },
  {
    ...
    description: 'Accelerated program for candidates with previous interpreting experience or knowledge.',
    duration: '3 weeks',
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 font-serif">Excel in NAATI CCL Test</h1>
              
              <p className="text-xl text-muted-foreground mb-8">
                Comprehensive preparation for NAATI Credentialed Community Language test with dialogue practice and expert guidance.
              </p>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Dialogue Interpretation</strong> - Two dialogues between an English speaker and a LOTE (Language Other Than English) speaker
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-orange-500 mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Format</strong> - Each dialogue consists of 300-350 words divided into segments
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-orange-500 mr-3 shrink-0 mt-0.5" />
                ...
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-orange-500 mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Scoring</strong> - Minimum 29/45 per dialogue to pass
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-orange-500 mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Immigration Points</strong> - Earn 5 additional points for Australian PR
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-orange-500 mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Cultural Recognition</strong> - Demonstrates proficiency in community language
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-orange-500 mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Professional Development</strong> - First step toward a career in translation
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-orange-500 mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Widely Recognized</strong> - Accepted by the Department of Home Affairs
                  </span>
                </li>
              </ul>
            </div>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
            {naatiCourses.map((course) => (
              <div 
                key={course.id}
                className={`bg-card border ${course.highlight ? 'border-orange-500' : 'border-border'} rounded-xl overflow-hidden transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full ${course.highlight ? 'shadow-lg ring-1 ring-orange-500/20' : 'shadow-sm'}`}
              >
                {course.highlight && (
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <Button asChild className={course.highlight ? "bg-orange-500 hover:bg-orange-600" : ""}>
                        <Link href="/booking" className="text-sm">Enroll Now</Link>
                      </Button>
                    </div>
                  </div>
                </div>
