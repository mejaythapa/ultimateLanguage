      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div>
          ...
          <p className="text-muted-foreground mb-6">
            Have questions about our courses or need assistance? Fill out the form and our team will get back to you shortly.
          </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+61 123 456 789</p>
                  <p className="text-muted-foreground">Mon-Fri 9AM to 6PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">info@alphapte.com</p>
                  <p className="text-muted-foreground">support@alphapte.com</p>
                </div>
              </div>
