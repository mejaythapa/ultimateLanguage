...
export const metadata: Metadata = {
  title: 'Contact Us | Alpha PTE & NAATI Coaching',
  description: 'Get in touch with our team for inquiries about our PTE and NAATI coaching services, or visit us at our training center.',
  openGraph: {
    title: 'Contact Us | Alpha PTE & NAATI Coaching',
    description: 'Get in touch with our team for inquiries about our PTE and NAATI coaching services, or visit us at our training center.',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Contact Alpha PTE & NAATI Coaching',
      },
    ],
    type: 'website',
  },
        ...
        <Container>
          ...
          <div className="mt-8 h-96 rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="w-full h-full bg-gray-300 flex items-center justify-center">
              <p className="text-gray-600">Google Maps Embed would appear here</p>
            </div>
          </div>
          
          <div className="mt-8 text-center">
            <h3 className="text-xl font-semibold mb-2">Alpha PTE & NAATI Coaching Center</h3>
            <p className="text-muted-foreground">123 Education Street, Sydney, NSW 2000, Australia</p>
            <p className="text-muted-foreground mt-2">
              <strong>Opening Hours:</strong> Monday to Friday: 9AM - 6PM | Saturday: 10AM - 4PM | Sunday: Closed
            </p>
          </div>
        </Container>
      </section>
