...
export const metadata: Metadata = {
  title: 'PTE Academic Coaching | Alpha PTE & NAATI',
  description: 'Comprehensive PTE Academic coaching with expert instructors. Master all four communicative skills and achieve your target score.',
  openGraph: {
    title: 'PTE Academic Coaching | Alpha PTE & NAATI',
    description: 'Comprehensive PTE Academic coaching with expert instructors. Master all four communicative skills and achieve your target score.',
    images: [
...
const pteCourses = [
  {
    ...
    description: 'Our flagship comprehensive PTE preparation program covering all four communicative skills with personalized feedback and guidance.',
    duration: '8 weeks',
  ...
  },
  {
    ...
    description: 'Accelerated preparation designed for busy professionals who need to achieve their target score quickly.',
    duration: '4 weeks',
  ...
  },
  {
    ...
    description: 'Specialized course focusing on the speaking and writing sections of the PTE Academic test.',
    duration: '6 weeks',
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 font-serif">Master the PTE Academic Test</h1>
              
              <p className="text-xl text-muted-foreground mb-8">
                Comprehensive preparation for all sections of the PTE Academic test with expert instructors and proven strategies.
              </p>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Speaking & Writing</strong> - Tests your ability to speak English and write responses to given tasks
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-primary mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Reading</strong> - Assesses your reading and comprehension skills through various tasks
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-primary mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Listening</strong> - Evaluates your ability to understand spoken English in various contexts
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-primary mr-3 shrink-0 mt-0.5" />
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-primary mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Fast Results</strong> - Typically available within 48 hours
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-primary mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Widely Accepted</strong> - Recognized by thousands of institutions worldwide
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-primary mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Computer-Based</strong> - Objective scoring with AI technology
                  </span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-primary mr-3 shrink-0 mt-0.5" />
                  <span>
                    <strong>Flexible Scheduling</strong> - Tests available throughout the year
                  </span>
                </li>
              </ul>
            </div>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
            {pteCourses.map((course) => (
              <div 
                key={course.id}
                className={`bg-card border ${course.highlight ? 'border-primary' : 'border-border'} rounded-xl overflow-hidden transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full ${course.highlight ? 'shadow-lg ring-1 ring-primary/20' : 'shadow-sm'}`}
              >
                {course.highlight && (
